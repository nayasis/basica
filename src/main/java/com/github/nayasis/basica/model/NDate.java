...
import com.github.nayasis.basica.reflection.deserializer.NDateDeserializer;
import com.github.nayasis.basica.reflection.serializer.SimpleNDateSerializer;
...
public class NDate implements Serializable {
    ...
    public int compareTo( NDate date ) {
        ...
        return Long.compare( srcTime, trgTime );
    }
