...
package com.github.nayasis.basica.resource.type.abstracts;
...
public abstract class AbstractFileResolvingResource extends AbstractResource {
	...
	public boolean isFile() {
		try {
			...
			return Resources.URL_PROTOCOL_FILE.equals(url.getProtocol());
		}
		catch (IOException ex) {
			return false;
		}
	...
	protected File getFileForLastModifiedCheck() throws IOException {
		...
		if ( Resources.isJarURL(url)) {
			URL actualUrl = Resources.extractArchiveURL(url);
	...
	protected boolean isFile(URI uri) {
		try {
			...
			return Resources.URL_PROTOCOL_FILE.equals(uri.getScheme());
		}
		catch (IOException ex) {
			return false;
		}
	 ...
	 * <p>Calls {@link Resources#useCachesIfNecessary(URLConnection)} and
