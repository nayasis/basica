...
package io.nayasis.basica.base.resource;

import io.nayasis.basica.base.resource.vo.FileSystemResource;
import io.nayasis.basica.base.resource.vo.UrlResource;
import io.nayasis.basica.base.resource.vo.VfsResource;
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	public PathMatchingResourcePatternResolver(ResourceLoader resourceLoader) {
		Assert.isNotNull(resourceLoader, "ResourceLoader must not be null");
	...
	public void setPathMatcher(PathMatcher pathMatcher) {
		Assert.isNotNull(pathMatcher, "PathMatcher must not be null");
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		Assert.isNotNull(locationPattern, "Location pattern must not be null");
