...
package io.nayasis.basica.base.resource.vo;

import io.nayasis.basica.base.resource.Assert;
import io.nayasis.basica.base.resource.Resource;
import io.nayasis.basica.base.resource.StringUtils;
...
public class FileSystemResource extends AbstractResource implements WritableResource {
	...
	public FileSystemResource(Path filePath) {
		Assert.isNotNull(filePath, "Path must not be null");
	...
	public FileSystemResource(FileSystem fileSystem, String path) {
		Assert.isNotNull(fileSystem, "FileSystem must not be null");
		Assert.isNotNull(path, "Path must not be null");
		this.path = StringUtils.cleanPath(path);
		this.file = null;
