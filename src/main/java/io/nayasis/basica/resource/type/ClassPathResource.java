...
import io.nayasis.basica.resource.type.abstracts.AbstractFileResolvingResource;
import io.nayasis.basica.resource.type.interfaces.Resource;
import io.nayasis.basica.resource.util.PathModifier;
...
import static io.nayasis.basica.base.Classes.SEPARATOR_PACKAGE;
import static io.nayasis.basica.base.Classes.SEPARATOR_PATH;
...
public class ClassPathResource extends AbstractFileResolvingResource {
	...
	public ClassPathResource( String path, ClassLoader classLoader ) {
		...
		String pathToUse = PathModifier.clean(path);
	...
	private String classPackageAsResourcePath( Class<?> clazz) {

		if (clazz == null) return "";

		String className = clazz.getName();
		int packageEndIndex = className.lastIndexOf(SEPARATOR_PACKAGE );
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ClassPathResource)) return false;
		ClassPathResource otherRes = (ClassPathResource) other;
		return (this.path.equals(otherRes.path) &&
				Validator.isEqual(this.classLoader, otherRes.classLoader) &&
				Validator.isEqual(this.clazz, otherRes.clazz));
	}
