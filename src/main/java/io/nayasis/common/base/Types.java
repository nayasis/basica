...
public class Types {
    ...
    public static boolean isMap( Class klass ) {
        return ( klass != null && Classes.getTopSuperClass( klass ) == AbstractMap.class );
    }
    ...
    public static boolean isList( Class klass ) {
        ...
        Class<?> superClass = Classes.getTopSuperClass( klass );
    ...
    public static boolean isPrimitive( Class klass ) {
        return Primitive.isPrimitive( klass ) || Primitive.isWrapper( klass );
    }
